        ...
        <div class="layout-page">
          ...
          >
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                ...
                <form action="{{ route('bendahara.dashboard') }}" method="GET" class="d-flex align-items-center">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                            ...
                            <table class="table">
                                ...
                                <tbody class="table-border-bottom-0">
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td class="p-3">{{$item->user->keluarga->email_keluarga}}</td>

                                        <td class="p-3">{{$item->user->name}}</td>

                                        <td class="p-3">Rp.{{ number_format($item->jumlah_transfer, 0, ',', '.') }}</td>
              ...
              <div class="modal fade" id="backDropModal" data-bs-backdrop="static" tabindex="-1">
                ...
                <div class="modal-dialog">
                    ...
                    <form class="modal-content" action="{{ route('keuangan.import') }}" method="POST" enctype="multipart/form-data">

                        @csrf

                        <div class="modal-header">

                            <h5 class="modal-title" id="backDropModalTitle">Impor Excel</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row g-2 mt-2">
                                ...
                                <div class="col mb-0">
                                    ...
                                    <input type="file" name="import" id="import" class="form-control" placeholder="Masukkan file excel..."/>
